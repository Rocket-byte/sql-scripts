...
DECLARE @EndDate DATE = '2017-04-30';
...
-- Main query to reconcile and compare sales data between SalesData and LabData
SELECT 
...
FROM 
    SalesData Cc
FULL JOIN 
    LabData Lab ON Cc.Order_Uid_1c = Lab.Order_Uid AND Cc.Curr_1c = Lab.Curr_Id
WHERE 
